...
const ProductPreview = ({ image }) => {
  return (
    <div className="bg-white rounded-lg overflow-hidden shadow-lg" style={{ width: '324px', height: '702px', maxWidth: '100%' }}>
      {/* 商品主图 */}
      <div className="relative w-full" style={{ height: '324px' }}>
      ...
      {/* 底部购买栏 */}
      <div className="bg-white border-t p-3 flex items-center gap-2 mt-auto">
